...
const WidgetCustomization = () => {
  ...
  if (isLoading) {
    return (
      <div className="flex flex-col gap-y-4 w-full min-h-screen items-center justify-center bg-card p-8">
  ...
  return (
    ...
    >
      <div className="flex min-h-screen w-full flex-col bg-card p-8">
